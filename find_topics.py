...
product_set = ('iphone', 'apple','plus','galaxy',' 10','s9',' 8','samsung',
               ...
               's8','phone','mobile','xz2','emoji','quite','super','bixby',
...
fromUser = 'Google Pixel 2xl review'
sql = """select url
            from video_info
...
ax2.plot(time_points/60, word_counts[:,topic_num], label="Topic "+str(topic_num))
ax1.plot(time_points/60, similarities[:,topic_num], label="Topic "+str(topic_num))
